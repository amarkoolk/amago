...
if __name__ == "__main__":
    ...
    # gym_config["scenarios"] = ["CutInSlowDown"]
    ...
    env = gym.wrappers.RecordVideo(env, video_folder="/p/crash/amago_multi_lane_vids",
    ...
    for trial in range(args.trials):
        ...
        experiment.start()
        experiment.load_checkpoint_from_path(args.ckpt)
